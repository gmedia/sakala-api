...
return [
    /*
     * Local access is always allowed by Scramble. Other environments must opt in.
     */
    ...
    'info' => [
         ...
         * API version.
         */
        'version' => env('SAKALA_API_VERSION', 'v1'),

        /*
         * Description rendered on the home page of the API documentation (`/docs/api`).
         */
        'description' => 'Control plane API for the Sakala open-source deployment platform.',
    ],
